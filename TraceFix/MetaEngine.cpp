...
void ENGINE_POST_TraceLine(const float* vStart, const float* vEnd, int fNoMonsters, edict_t* pentToSkip, TraceResult* ptr)
{
	gTraceFix.TraceLine(vStart, vEnd, fNoMonsters, pentToSkip, ptr);
